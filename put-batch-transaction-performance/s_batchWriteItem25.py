...
handler_wrapper_kwargs = {'function_name': 'dynamodb-performance-testing-dev-batchWriteItem25', 'timeout': 6}
try:
    user_handler = serverless_sdk.get_user_handler('batch_write.handler')
